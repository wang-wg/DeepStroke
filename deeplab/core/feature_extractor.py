...
#LTH
#_MEAN_RGB = [156.7, 156.7, 156.7]

#base
_MEAN_RGB = [184.467, 184.467, 184.467]

#HLJ
#_MEAN_RGB = [158.38, 158.38, 158.38]

#SS
#_MEAN_RGB = [179.90, 179.90, 179.90]

#LTH stroke
#_MEAN_RGB = [178.32, 178.32, 178.32]
...
def _preprocess_zero_mean_unit_range(inputs):
  ...
  return(2.0 / 255.0) * tf.to_float(inputs)-1
#  resultA=(2.0 / 255.0) * tf.to_float(inputs[:,:,:,0:3])-1
#  resultB=(2.0 / 33.0) * tf.to_float(inputs[:,:,:,3:4])-1
#  return tf.concat([resultA,resultB],3)
