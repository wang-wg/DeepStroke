...
def image_seg_to_tfexample(image_data, filename, height, width, seg_data,stroke_list,skel_data,skel_35_data, stroke_order_list, seg_data_order):
  ...
  return tf.train.Example(features=tf.train.Features(feature={
      ...
      'image/segmentation/class/format': _bytes_list_feature(
          FLAGS.label_format),
      'image/segmentationOrder/class/encoded': (
          _bytes_list_feature(seg_data_order)),
      'image/stroke': _int64_list_feature(stroke_list),
      'image/strokeorder': _int64_list_feature(stroke_order_list),
      'image/skel': _bytes_list_feature(skel_data),
      'image/skel_35': _bytes_list_feature(skel_35_data),
  }))
