...
def _convert_dataset(dataset_split, dataset_type_dir):
  ...
  #add strokeNum and other imformation
  ...
  for shard_id in range(_NUM_SHARDS):
    ...
    with tf.python_io.TFRecordWriter(output_filename) as tfrecord_writer:
      ...
      for i in range(start_idx, end_idx):
        ...
        file_name_for_LTH=filenames[i][0:filenames[i].index("_")]+'_R'
        ...
        skel_filename = os.path.join(
              ...
              file_name_for_LTH + '.' + FLAGS.label_format)
...
def main(unused_argv):
  dataset_type_dir='/home/wwg/data/CCSSD/DATA_GB6763_HLJ/HLJ2017/'
  #list_folder = dataset_type_dir+'ImageSets/Segmentation/0.5test/aa'
  list_folder = '/home/wwg/data/CCSSD/DATA_GB6763_hand/hand2017/'
  ...
  dataset_type_all=['hand']#['FZLBJW','HLJ','SS']
